...
typedef struct {
   std::string realm;                    // realm of route
   std::string role;                     // realm role 
   AAAApplicationId id;                  // application id
   AAA_DataPeer *peer;                   // peer data
} AAA_DataRoute;
...
typedef struct {
   diameter_integer32_t console;         // enable|disable stdout target

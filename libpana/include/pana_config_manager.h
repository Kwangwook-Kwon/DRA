    ...
    private:
        typedef union {
           struct {
              ...
              ACE_UINT32 m_Dhcp        : 1;
              ACE_UINT32 m_Stateless   : 1;
              ACE_UINT32 m_Tunnel      : 1;
              ACE_UINT32 m_IKEv2       : 1;
              ACE_UINT32 reserved      : 27;
           } u;
           ACE_UINT32 v;
        } Flags;
    public:
        ...
        bool Dhcp() {
            return (m_Flags.u.m_Dhcp) ? true : false;
        }
        bool Stateless() {
            return (m_Flags.u.m_Stateless) ? true : false;
        }
        bool Tunnel() {
            return (m_Flags.u.m_Tunnel) ? true : false;
        }
        bool IKEv2() {

...
//-------------------------------------------
// 7.1.1  Informational  (draft-ietf-aaa-diameter-17.txt)
/*
...
//-------------------------------------------------
// 7.1.2  Success (draft-ietf-aaa-diameter-17.txt)
/*
...
//-------------------------------------------------
//7.1.3  Protocol Errors (draft-ietf-aaa-diameter-17.txt)
/*
...
#define      AAA_UNABLE_TO_DELIVER         3002
	/*
         ...
         available to process the request, or because Destination-Host
...
//-------------------------------------------------
// 7.1.4  Transient Failures (draft-ietf-aaa-diameter-17.txt)
/*
...
//-------------------------------------------------
// 7.1.5  Permanent Failures (draft-ietf-aaa-diameter-17.txt)
/*
...
#define AAA_NO_COMMON_SECURITY        5017
	/*
         This error is returned when a CER message is received, and
         there are no common security mechanisms supported between the
         peers. A Capabilities-Exchange-Answer (CEA) MUST be returned
         with the Result-Code AVP set to AAA_NO_COMMON_SECURITY.
	*/
#endif
